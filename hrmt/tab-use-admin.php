...
while ($datos = $sql->fetch_object()) {
    echo "<tr>
        ...
        <td>{$datos->Tipo}</td>
        <td>
            <a href=\"javascript:abUser('{$datos->Ncontrol}')\" class='btn btn-sm btn-warning' title='Editar'>
        ...
        <td>
            <a href=\"javascript:EliminarUser('{$datos->Ncontrol}')\" class='btn btn-sm btn-danger' title='Eliminar' >
                <svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' fill='currentColor' viewBox='0 0 24 24'>
                    <path stroke='none' d='M0 0h24v24H0z' fill='none'/>
